...
<body>
    ...
    <footer class="site-footer">
      <div class="container">
        ...
        <p class="copyright">&copy; 2016 Planview Inc., All Rights Reserved</p>
      </div>
    </footer>

    {{ HTML::script('bower_components/requirejs/require.js', ['data-main' => '/js/kickoff-2016.js']) }}
    {{ $page->scripts }}
</body>
</html>
